...
const handleUpdateLessons = (data,event) => {
...
console.log(newArray);
 ...
 setTimeout(() => {
  ...
  event.preventDefault();
    ...
    const {data:contentsDetails = [],isLoading:isLoading1 ,refetch:refetch1} = useQuery({
        queryKey:[topicId],
        queryFn: async () => {
