...
const EditBlogs = ({handleEdit,isEdit,setIsPreview}) => {
  return (
    <form action="#" id="drawer-update-product" class={` fixed top-20 left-0 z-40 w-full h-5/6 max-w-3xl p-4 overflow-y-auto transition-transform ${isEdit && "-translate-x-full"} bg-white dark:bg-gray-800`} tabindex="-1" aria-labelledby="drawer-update-product-label" aria-hidden="true">
