...
const AllBlogs = ({blogs,isLoading,refetch}) => {
  ...
  const handleUpdate = async (id) => {
    ...
    if(window.confirm('Are you sure to Approved this blog?')){
...
//console.log(result);
        if(result.modifiedCount > 0){
            toast.success('Succesfully Approved Blog!!');
            refetch();
              }
...
//   queryKey:['blogs',queryBlog],
//   queryFn: async()=> {
//     const res = await fetch(`http://localhost:5000/blogs/${queryBlog}`)
  ...
  if(window.confirm('Are you sure to Delete this blog?')){
    ...
    .then(result=> {
      if(result.deletedCount>0){
        toast.success('Succesfully deleted Blog!!');
        refetch();
      }
  ...
  return (
    <div className='mt-12'>
      {/* <!-- Start block --> */}
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    {/* <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                        <div class="flex-1 flex items-center space-x-2">
                            <h5>
                                <span class="text-gray-500">All {status === 'pending'?'pending':'accepted'} Blogs:</span>
                                <span class="dark:text-white">{blogs.length}</span>
                            </h5>
                    ...
                    <div class="flex flex-col md:flex-row items-stretch md:items-center md:space-x-3 space-y-3 md:space-y-0 justify-between mx-4 py-4 border-t dark:border-gray-700">
                        ...
                        <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                           <Link to="/blogWrite"> <button type="button" id="createProductButton" data-modal-toggle="createProductModal" class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
        ...
        {/* <!-- drawer component --> */}
             {initialEdit && <EditBlogs handleEdit={handleEdit} isEdit={isEdit} ></EditBlogs>}
        {/* <!-- Preview Drawer --> */}
