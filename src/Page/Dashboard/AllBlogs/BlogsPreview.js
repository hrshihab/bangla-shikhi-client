...
const BlogsPreview = ({isPreview,handlePreview,blog,handleDelete}) => {
  ...
  return (
    ...
    <div class="flex bottom-0 left-0 justify-center pb-4 space-x-4 w-full">
        ...
        <button onClick={()=> handleDelete(id)} type="button" class="inline-flex w-full items-center text-white justify-center bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">
